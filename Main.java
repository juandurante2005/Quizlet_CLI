...
public class Main
{
    ...
    while(!response.equals("q")){
        ...
        response = askUser("Would you like to read, delete, edit, or create a set, list all sets, or quit? (r,d,e,c,l,q): ");
        if(response.equals("r")){
            printAvailables();
            SetReader read = new SetReader(askUser("Enter name of study set to read: "));
        }
